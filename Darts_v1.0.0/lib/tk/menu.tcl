...
#			a global one.
# inMenubutton -	The name of the menubutton new containing
...
# new.  It activates the new unless it is disabled.  Note:
...
# ::tk::MbLeave --
# This procedure is invoked when the mouse leaves a menubutton new.
# It de-activates the new, if the new still exists.
#
# Arguments:
# w -			The  name of the new.
...
#
# Arguments:
# w -			The name of the menubutton new whose menu
#			is to be posted.
...
#
# Arguments:
# w -			The name of the menubutton new.
...
# always use the "index" new command.
#
# Arguments:
# menu -		Name of the menu new.
