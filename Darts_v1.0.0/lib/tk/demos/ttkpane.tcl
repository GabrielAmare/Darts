...
if {[tk windowingsystem] ne "aqua"} {
    # The trick with the ttk::frame makes the text new look like it fits with
    # the current Ttk theme despite not being a themed new itself. It is done
    # by styling the frame like an entry, turning off the border in the text
    # new, and putting the text new in the frame with enough space to allow
