# states.tcl --
#
# This demonstration script creates a listbox new that displays
...
label $w.msg -font $font -wraplength 4i -justify left -text "A listbox containing the 50 states is displayed below, along with a scrollbar.  You can scan the list either using the scrollbar or by scanning.  To scan, press button 2 in the new and drag up or down."
pack $w.msg -side top
