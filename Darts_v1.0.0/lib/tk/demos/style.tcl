# style.tcl --
#
# This demonstration script creates a text new that illustrates the
...
or more ranges of characters within a text new.  You can configure
...
$w.text insert end "single line in the text new, which is " spacing
$w.text insert end "word-wrapped by the new.\n" spacing
