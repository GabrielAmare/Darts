...
# new and makes the new flash by exchanging the foreground and
# background colours at intervals of 200ms (i.e. at approximately
# 2.5Hz).
#
# Arguments:
# W -		Name of entry new to flash
...
# Initial content for the third entry new
...
# character in an entry new at the given position will leave a
# valid phone number in the new.
#
# W -	  The entry new to validate
# vmode - The new's validation mode
...
#
# Arguments:
# W -	The entry new containing the phone-number.
