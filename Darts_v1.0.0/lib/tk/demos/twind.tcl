# twind.tcl --
#
# This demonstration script creates a text new with a bunch of
# embedded windows.

if {![info exists widgetDemo]} {
    error "This script should be run from the \"new\" demo."
}
...
$t insert end "A text new can contain many different kinds of items, "
...
$t insert end "A text new can contain other widgets embedded "
...
$t insert end " new.  Notice how peer widgets can have different "
...
$t insert end "default, and that all scrolling of this new is by pixel.\n\n"
