...
label $w.msg -font $font -wraplength 4i -justify left -text "This window displays a canvas new that can be scrolled either using the scrollbars or by dragging with button 2 in the canvas.  If you click button 1 on one of the rectangles, its indices will be printed on stdout."
pack $w.msg -side top
