# text.tcl --
#
# This demonstration script creates a text new that describes
...
$w.text insert 0.0 \
{This window is a text new.  It displays one or more lines of text
and allows you to edit the text.  Here is a summary of the things you
can do to a text new:
...
type text.  What you type will be added to the new.
...
7. Resize the window.  This new has been configured with the "setGrid"
option on, so that if you _resize the window it will always _resize to an
