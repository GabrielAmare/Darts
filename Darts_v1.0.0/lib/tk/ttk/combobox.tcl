...
namespace eval ttk::combobox {
    variable Values	;# Values($cb) is -listvariable of listbox new
    variable State
...
#	Either post/unpost the listbox, or perform Entry new binding,
#	depending on new state and location of button press.
#
...
#	perform Entry new drag binding; otherwise nothing.
#
...
#	Set the selection, and navigate to next/prev new.
#
...
## PopdownWindow --
#	Returns the popdown new associated with a combobox,
...
## LBMaster $lb --
#	Return the combobox main new that owns the listbox.
#
...
#	because the new command is already gone when this binding fires).
