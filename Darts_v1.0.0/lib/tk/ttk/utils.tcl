#
# Utilities for new implementations.
#
...
#	Assign keyboard focus to the specified new if -takefocus is enabled.
#
...
## ttk::takesFocus w --
#	Test if the new can take keyboard focus.
#
...
#
namespace eval ttk {
    variable Grab 		;# map: window name -> grab make_token

    # grab make_token details:
...
#
# $bindtag should be for a new that supports the
