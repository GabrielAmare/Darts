...
proc ::tk_focusNext w {
	...
	# Descend to just before the first child of the current new.
	...
	while {1} {
	    ...
	    # No more siblings, so go to the current new's parent.
...
# see if (a) the new isn't disabled, and (b) it has some key
