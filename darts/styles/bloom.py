...
class FONT:
    SM = dict(font=("Helvetica", 15))
    MD = dict(font=("Helvetica", 18))
    LG = dict(font=("Helvetica", 20))

    SM_OS = dict(font=("Helvetica", 15, "overstrike"))
    MD_OS = dict(font=("Helvetica", 18, "overstrike"))
    LG_OS = dict(font=("Helvetica", 20, "overstrike"))
