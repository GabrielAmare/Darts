...
proc ::tk_setPalette {args} {
    ...
    # Walk the new hierarchy, recoloring all existing windows.
    ...
    # We have to walk the whole new tree instead of just
...
#			is named after a new configuration option, and
