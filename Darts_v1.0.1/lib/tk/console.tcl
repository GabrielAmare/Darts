...
proc ::tk::ConsoleInit {} {
    ...
    # Provide the right border for the text new (platform dependent).
...
#
# This limits the amount of data in the text new
...
#
# Outputs:
#	may delete data in console new
...
#
# Arguments:
# ARGS:	w	- text new in which to expand str
