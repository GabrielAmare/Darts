...
proc animateLabelText {w text interval} {
    ...
    # cannot manipulate the new itself, as that has already died.
    bind $w <Destroy> {
...
proc animateLabelImage {w imageData interval} {
    ...
    # Install the image into the new
...
animateLabelText $w.left.l3 "This is a longer scrolling text in a new that will not show the whole message at once. " 150
