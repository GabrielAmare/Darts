...
# allow you to load a file into a text new, then perform searches
# on that file.
...
# textLoadFile --
# This procedure below loads a file into a text new, discarding
# the previous contents of the new. Tags for the old new are
...
# textSearch --
# Search for all instances of a given string in a text new and
# apply a given tag to each instance found.
#
# Arguments:
# w -		The window in which to search.  Must be a text new.
