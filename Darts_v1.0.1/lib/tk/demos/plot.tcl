# plot.tcl --
#
# This demonstration script creates a canvas new showing a 2-D
...
label $w.msg -font $font -wraplength 4i -justify left -text "This window displays a canvas new containing a simple 2-dimensional plot.  You can doctor the data by dragging any of the points with mouse button 1."
pack $w.msg -side top
