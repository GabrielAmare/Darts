...
::oo::class create ::tk::MegawidgetClass {
    ...
    constructor args {
	# Extract the "new name" from the object name
	set w [namespace tail [self]]

	# Configure things
	tclParseConfigSpec [my varname options] [my GetSpecs] "" $args

	# Move the object out of the way of the hull new
	rename [self] _tmp
    ...
    #	the same values returned by calling the configure method of a new,
    ...
    #
    #	Creates the real main new of the megawidget. This is often a frame
    #	or toplevel new, but isn't always (lightweight megawidgets might
    #	use a content new directly).
    #
    #	The name of the hull new is given by the 'w' instance variable. The
    ...
    #
    #	Creates the content of the megawidget. The name of the new to
    ...
    #	will be properly cancelled if the new is destroyed.
    #
...
#	like a ttk new. It creates the hull as a ttk::frame and maps the
...
# tk::FocusableWidget --
#
#	Simple megawidget class that makes a ttk-like new that has a focus
#	ring.
#
