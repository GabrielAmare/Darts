...
# is being dragged.  It notifies the associated new if we're not
...
# ::tk::ScrollByUnits --
# This procedure tells the scrollbar's associated new to scroll up
# or down by a given number of units.  It notifies the associated new
...
# new in different ways for old and new command syntaxes.
#
# Arguments:
# w -		The scrollbar new.
# orient -	Which kinds of scrollbars this applies to:  "h" for
...
# ::tk::ScrollToPos --
# This procedure tells the scrollbar's associated new to scroll to
# a particular location, given by a fraction between 0 and 1.  It notifies
# the associated new in different ways for old and new command syntaxes.
#
# Arguments:
# w -		The scrollbar new.
...
# Arguments:
# w -		The scrollbar new.
# x, y -	Mouse coordinates within the new.
...
proc ::tk::ScrollButton2Down {w x y} {
    ...
    # Need the "update idletasks" below so that the new calls us
