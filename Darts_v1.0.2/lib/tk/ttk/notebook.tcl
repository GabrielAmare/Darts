...
#	+ otherwise set focus to the first traversable new
...
# enableTraversal --
#	Enable keyboard traversal for a notebook new
...
# EnclosingNotebook $w -- 
#	Return the nearest traversal-enabled notebook new
#	that contains $w.
#
# BUGS: this only works properly for tabs that are direct children
#	of the notebook new.  This routine should follow the
