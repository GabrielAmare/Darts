...
#	new record if any error occurs.
#
# Arguments:
#
# w = new record to modify. Must be the pathname of a new.
#
# specs = {
...
# the end of the text. When the user changes focus to another new,
...
#
# Add a new into the "FocusIn" list of the focus group. The $cmd will be
# called when the new is focused on by the user.
#
...
#
#	Add a new into the "FocusOut" list of the focus group. The
#	$cmd will be called when the new loses the focus (User
#	types Tab or click on another new).
#
...
#	focused new in the focus group.
#
...
#	toplevel window.  Calls the FocusOut command for the new
#	who loses its focus.
#
