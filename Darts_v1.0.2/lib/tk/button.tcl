...
# button new.  It records the button we're in and changes the
# state of the button to active unless the button is disabled.
#
# Arguments:
# w -		The name of the new.
...
# button new.  It changes the state of the button back to inactive.
...
# a button new.  It records the fact that the mouse is in the button,
...
# in a button new.  It restores the button's relief and invokes
...
# ::tk::CheckRadioEnter --
# The procedure below is invoked when the mouse pointer enters a
# checkbutton or radiobutton new.  It records the button we're in
...
# ::tk::ButtonLeave --
# The procedure below is invoked when the mouse pointer leaves a
# button new.  It changes the state of the button back to
...
# ::tk::CheckRadioInvoke --
# The procedure below is invoked when the mouse button is pressed in
# a checkbutton or radiobutton new, or when the new is invoked
# through the keyboard.  It invokes the new if it
# isn't disabled.
#
# Arguments:
# w -		The name of the new.
