...
proc ::tk::dialog::file:: {type args} {
    ...
    ::tk::PlaceWindow $w new $data(-parent)
...
# -anchor w -padx 3
    ...
    # Pack all the frames together. We are done with new construction.
    #
...
#
#	Loads the files and directories into the IconList new. Also sets up
...
# Gets called when user browses the IconList new (dragging mouse, arrow
# keys, etc)
#
...
# Gets called when user invokes the IconList new (double-click, Return key,
# etc)
#
