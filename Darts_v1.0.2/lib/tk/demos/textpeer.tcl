...
## Define a new that we peer from; it won't ever actually be shown though
...
$first insert end "the Make Peer button beside the text new to clone, and "
$first insert end "delete a particular peer new using the Delete Peer "
